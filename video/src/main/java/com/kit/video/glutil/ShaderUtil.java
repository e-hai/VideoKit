...
public class ShaderUtil {
    ...
    public static int loadShader(int shaderType, String source) {
        ...
        if (compiled[0] == 0) {
            Log.d(TAG, String.format("Could not compile shader %d: %s", shaderType, GLES20.glGetShaderInfoLog(shader)));
    ...
    public static int createProgram(
        ...
        if (linkStatus[0] != GLES20.GL_TRUE) {
            Log.d(TAG, String.format("Could not link program: %s", GLES20.glGetProgramInfoLog(program)));
    ...
    public static FloatBuffer floatBuffer(final int length) {
        return ByteBuffer
    ...
    public static ShortBuffer shortBuffer(short... values) {
        final ShortBuffer buffer = ByteBuffer
                .allocateDirect(values.length * 2)
                .order(ByteOrder.nativeOrder())
                .asShortBuffer();
